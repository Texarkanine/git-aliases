...
- **[git-wt](subcommands/git-wt/README.md)**: Create and tear down linked worktrees at `~/worktrees/<owner>/<repo>/<repo>-<branch>`, or under `GITWT_ROOT` when that variable is an absolute path
